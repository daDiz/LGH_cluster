...
import sys
sys.path.insert(0, 'code_dir/LoGraPov_v1.0')
import os
import numpy as np
...
def main():
    ...
    if task == 'initialize':
        ...
        os.system("python3 code_dir/LoGraPov_v1.0/initialize.py %s" % (config_file))

    elif task == 'rewire':
  	    os.system("qsub submit_rewiring.pbs")

    elif task == 'hawkes':
        os.system("python3 code_dir/LoGraPov_v1.0/wr_bundle_sample_hawkes.py %s && qsub submit_bundle_sample_hawkes.pbs" % (config_file))

    elif task == 'eclog':
        os.system("python3 code_dir/LoGraPov_v1.0/format_eclog_input.py %s && python3 code_dir/LoGraPov_v1.0/wr_submit_eclog.py %s && python3 code_dir/LoGraPov_v1.0/submit_mul_eclog.py %s" % (config_file, config_file, config_file))
