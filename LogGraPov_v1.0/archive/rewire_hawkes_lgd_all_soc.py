...
#dest_path = 'soc-wiki-vote/soc-wiki-vote_rewired_all/soc-wiki-vote'
#outfile = 'soc-wiki-vote/soc-wiki-vote_all_exactHawkes_labeled.txt'
#alpha = 0.99 # theta / lambda_max -> value used in samira paper
